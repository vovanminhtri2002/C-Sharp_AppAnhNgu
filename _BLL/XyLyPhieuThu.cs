...
namespace _BLL
{
    public class XyLyPhieuThu
    {
        ...
        public List<PhieuThu> GetPhieuThu()
        {
            ...
            return PhieuThuContext.PhieuThus.Select(pt => pt).ToList<PhieuThu>();
        }
        ...
        {
            // Tìm phiếu thu cần cập nhật trạng thái
            ...
            {
                // Thực hiện cập nhật trạng thái thành "Đã thanh toán"
                phieuThuCanCapNhat.TrangThai = "Đã thanh toán";

                // Submit các thay đổi vào cơ sở dữ liệu
                PhieuThuContext.SubmitChanges();
            }
        }
        ...
        public string TenKhoaHocDaDangKy(string maPhieuThu)
        {
            ...
            // Lấy toàn bộ các tên khóa học
            List<string> tenKhoaHocList = query.ToList();

            // Kết hợp các tên khóa học thành một chuỗi và trả về
