...
namespace Do_An_Chuyen_Nganh
{
    public partial class fPhanPhoiTaiLieu : Form
    {
        ...
        private void XulyCotTiengVietPTL()
        {
            ...
            dataPtl.Columns["MaHocVien"].HeaderText = "Mã Học Viên";
        ...
        {
            // Đổi tên cột để phản ánh thông tin đúng với tài liệu
            dataTaiLieu.Columns["MaTaiLieu"].HeaderText = "Mã Tài Liệu";
            dataTaiLieu.Columns["TenTaiLieu"].HeaderText = "Tên Tài Liệu";
            dataTaiLieu.Columns["MaKhoaHoc"].HeaderText = "Mã Khóa Học";
            dataTaiLieu.Columns["SoLuongTaiLieu"].HeaderText = "Số Lượng Tài Liệu";
        }
        private void dataTaiLieu_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (selectedRow != null)
            {
                ...
                string soLuongTaiLieu = selectedRow.Cells["SoLuongTaiLieu"].Value.ToString();
        ...
        private void LoadDataPTL()
        {
            ...
            combomahv.DataSource = phatTaiLieuProcessor.GetMaHocVien();
            combomatl.DataSource = phatTaiLieuProcessor.GetMaTaiLieu();
        }
        ...
        private void dataPtl_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (selectedRow != null)
            {
                ...
                combomahv.Text = maHocVien;
                combomatl.Text = maTaiLieu;
        ...
        {
            txtidptl.Clear();
            combomahv.SelectedIndex = -1;
            combomatl.SelectedIndex = -1;
        ...
        private void btnthemPTL_Click(object sender, EventArgs e)
        {
            PhatTaiLieu phatTaiLieu = new PhatTaiLieu
            {
                ...
                MaHocVien = combomahv.Text,
                MaTaiLieu = combomatl.Text,
